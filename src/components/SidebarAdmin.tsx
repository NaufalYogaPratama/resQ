...
import { BarChart3, Users, BookOpen, LogOut, Shield, ChevronDown,PieChart } from 'lucide-react';
...
export default function SidebarAdmin({ user }) {
  ...
  const navLinks = [
    ...
    { name: 'Analitik', href: '/admin/analitik', icon: PieChart }, // Atau ikon lain yang sesuai
