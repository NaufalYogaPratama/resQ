      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            {/* Tombol Lapor Darurat Dihapus dari Sini */}
             ...
             {/* Tombol Lapor Darurat Dihapus dari Sini */}
              <div className="mt-3">
                <div className="px-4 py-3 border-b border-indigo-700">
                 ...
                 <Link href="/warga/profil" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center w-full text-left mt-1 px-3 py-2 text-base font-medium text-indigo-100 hover:bg-indigo-800 rounded-md">
