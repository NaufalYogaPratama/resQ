  ...
  return (
    <div className={"font-sans text-[#1E293B] bg-gradient-to-b from-white via-indigo-50/25 to-white"}>
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div className="text-left" data-aos="fade-right">
                ...
                <p className="text-lg text-slate-600 mb-8 leading-relaxed max-w-xl">
                  Saat bencana, waktu adalah segalanya. ResQ mengubah niat baik menjadi aksi bersama, cepat, terarah,
                  dan berdampak.
                </p>
        ...
        <section
          id="fitur"
          className={"py-24 bg-gradient-to-b from-white via-violet-50/20 to-white -mt-20 relative z-10"}
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section id="tentang" className={"py-24 bg-gradient-to-br from-violet-50 via-white to-indigo-50/25"}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div data-aos="fade-right">
                ...
                <p className="text-xl text-slate-600 leading-relaxed">
                  ...
                  sendiri. Kami memberdayakan setiap warga untuk menjadi bagian dari solusi.
                </p>
              </div>
              <div className="space-y-8" data-aos="fade-left">
                {roles.map((role) => (
                  <div key={role.title} className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-lg flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-violet-100/80 via-white/60 to-indigo-100/80 border border-white/60 backdrop-blur-sm shadow-sm">
                      {role.icon}
                    </div>
                    <div>
        ...
        <section id="cara-kerja" className={"py-24 bg-gradient-to-b from-white via-indigo-50/20 to-white"}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">Cara Kerja Gotong Royong</h2>
      ...
      <footer
        className={"text-slate-600 border-t border-slate-200 bg-gradient-to-b from-white via-violet-50/15 to-white"}
      >
